	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			category1 : {
				name : 'ወንድ', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'ወንድ'}, //Name of the category presented in the task.
			...
			category2 :	{
				name : 'ሴት', //Will appear in the data and in the default feedback message.
				title : {
					media : {word : 'ሴት'}, //Name of the category presented in the task.
					css : {color:'#336600','font-size':'1.8em'}, //Style of the category title.
					height : 4 //Used to position the "Or" in the combined block.
				},
				stimulusMedia : [ //Stimuli content as PIP's media objects
			...
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'በምድቡ <b>left</b> የሚካተቱ  ዝርዝር ነገሮችን ምላሽ  ለመስጠት የግራ ጣትሽን/ ህን በአረንጓዴ  ቀለም በተጻፈው ቦታ (ቃል) ላይ አኑሪ/ር <font color="#0000ff">leftAttribute</font>.<br/>',
			...
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'በምድቡ <b>left</b> የሚካተቱ  ዝርዝር ነገሮችን ምላሽ  ለመስጠት የግራ ጣትሽን/ ህን በአረንጓዴ  ቀለም በተጻፈው ቦታ (ቃል) ላይ አኑሪ/ር <font color="#336600">leftCategory</font>.<br/>',
			...
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'አስተውይ/ል፣ የመለያ ቁልፎቹ ቦታ ተቀያይሯል!<br/>',
							'በምድቡ የሚካተቱ <b>left</b> ምላሽ ለመስጠት የግራ ጣትሽን/ ህን በአረንጓዴ ቀለም በተጻፈው ቦታ (ቃል) ላይ አኑሪ/ር  for <font color="#336600">leftCategory</font> items.<br/>',

...
define(['pipAPI','pipScorer','underscore'], function(APIConstructor, Scorer, _) {
	...
	/**
	Created by: Yoav Bar-Anan (baranan@gmail.com). Modified by Sreelakshmi Papineni
	...
	**/
	...
	function iatExtension(options)
	{
		...
		var iatObj =
		{
			...
			'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ' +
			'ለመቀጠል ሌላውን ቁልፍ ይጫኑ.<p/>',

			remindErrorTextTouch : '<p align="center" style="font-size:"1.4em"; font-family:arial">' +
			'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ' +
			'ለመቀጠል ሌላኛውን ጎን ይንኩ።.<p/>',
			...
			finalText : 'ወደ ቀጣዩ ተግባር ለመቀጠል ቦታን ይጫኑ', 
			finalTouchText : 'ወደ ቀጣዩ ስራ ለመቀጠል የታችኛውን አረንጓዴ ቦታ ይንኩ።',
			...
			instAttributePractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				...
				'የግራ ጣትን በላዩ ላይ ያድርጉ <b>E</b> የምድቡ አባል ለሆኑ ዕቃዎች ቁልፍ <font color="#0000ff">leftAttribute.</font>' +
				'<br/>በቀኝ ጣት ላይ ጣት ያድርጉ <b>I</b> የምድቡ አባል ለሆኑ ዕቃዎች ቁልፍ <font color="#0000ff">rightAttribute</font>.<br/><br/>' +
				'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ' +
				'ለመቀጠል ሌላውን ቁልፍ ይጫኑ.<br/>' +
				'<u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.<br/><br/></p>'+
				'<p align="center">የሚለውን ይጫኑ <b>space bar</b> ለመጀመር ዝግጁ ሲሆኑ.</font></p></div>',
			instAttributePracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'የግራ ጣት በላዩ ላይ ያድርጉ <b>left</b> የምድቡ ባለቤት ለሆኑ እቃዎች አረንጓዴ ቦታ <font color="#0000ff">leftAttribute</font>.<br/>',
						'የቀኝ ጣት በላዩ ላይ ያድርጉ <b>right</b> የምድቡ ባለቤት ለሆኑ እቃዎች አረንጓዴ ቦታ <font color="#0000ff">rightAttribute</font>.<br/>',
						'እቃዎች አንድ በአንድ ይታያሉ.<br/>',
						'<br/>',
						'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ሌላኛውን ጎን ይንኩ. <u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.',
					'</p>',
			...
			instCategoriesPractice: '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'የግራ ጣትን በላዩ ላይ ያድርጉ <b>E</b> የምድቡ አባል ለሆኑ ዕቃዎች ቁልፍ <font color="#336600">leftCategory</font>. ' +
				'<br/>በቀኝ ጣት ላይ ጣት ያድርጉ <b>I</b> የምድቡ አባል ለሆኑ ዕቃዎች ቁልፍ <font color="#336600">rightCategory</font>.<br/>' +
				'እቃዎች አንድ በአንድ ይታያሉ.<br/><br/>' +
				'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ' +
				'ለመቀጠል ሌላውን ቁልፍ ይጫኑ.<br/>' +
				'<u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.<br/><br/></p>'+
				'<p align="center">የሚለውን ይጫኑ <b>space bar</b> ለመጀመር ዝግጁ ሲሆኑ.</font></p></div>',
			instCategoriesPracticeTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'የግራ ጣት በላዩ ላይ ያድርጉ <b>left</b> የምድቡ ባለቤት ለሆኑ እቃዎች አረንጓዴ ቦታ <font color="#336600">leftCategory</font>.<br/>',
						'የቀኝ ጣት በላዩ ላይ ያድርጉ <b>right</b> የምድቡ ባለቤት ለሆኑ እቃዎች አረንጓዴ ቦታ <font color="#336600">rightCategory</font>.<br/>',
						'እቃዎች አንድ በአንድ ይታያሉ.<br/>',
						'<br/>',
						'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ሌላኛውን ጎን ይንኩ. <u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.',
					'</p>',
			...
			instFirstCombinedTouch:[
				'<div>',
					...
					'<br/>',
					'<p align="left" style="margin-left:5px">',
						'የግራ ጣት በላዩ ላይ ያድርጉ <b>left</b> green area for <font color="#336600">leftCategory</font> items and for <font color="#0000ff">leftAttribute</font>.</br>',
						'የቀኝ ጣት በላዩ ላይ ያድርጉ <b>right</b> green area for <font color="#336600">rightCategory</font> items and for <font color="#0000ff">rightAttribute</font>.</br>',
							'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ሌላኛውን ጎን ይንኩ. <u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.</br>',
						'</p>',
						'<p align="center">Touch the <b>lower </b> green area to start.</p>',
				'</div>'
			].join('\n'),
			...
			instSecondCombinedTouch:[
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						...
						'የቀኝ ጣት በላዩ ላይ ያድርጉ <b>right</b> green area for <font color="#336600">rightCategory</font> items and for <font color="#0000ff">rightAttribute</font>.<br/>',
						'<br/>',
						'<u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.<br/>',
					'</p>',
					'<p align="center">Touch the <b>lower </b> green area to start.</p>',
				'</div>'
			].join('\n'),
			...
			instSwitchCategories : '<div><p align="center" style="font-size:20px; font-family:arial">' +
				'<font color="#000000"><u>Part blockNum of nBlocks </u><br/><br/></p>' +
				'<p style="font-size:20px; text-align:left; vertical-align:bottom; margin-left:10px; font-family:arial">' +
				'<b>ይጠንቀቁ፣ መለያዎቹ ቦታ ተለውጠዋል!</b><br/>' +
				'የግራ ጣትን በላዩ ላይ ያድርጉት <b>E</b> key for <font color="#336600">leftCategory</font>.<br/>' +
				'የቀኝ ጣትን በላዩ ላይ ያድርጉት <b>I</b> key for <font color="#336600">rightCategory</font>.<br/><br/>' +
				'<u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.<br/><br/></p>' +
				'<p align="center">የሚለውን ይጫኑ <b>space bar</b> ለመጀመር ዝግጁ ሲሆኑ.</font></p></div>',
			instSwitchCategoriesTouch: [
				'<div>',
					...
					'<p align="left" style="margin-left:5px">',
						'<br/>',
						'ይጠንቀቁ፣ መለያዎቹ ቦታ ተለውጠዋል!<br/>',
							'የግራ ጣት በላዩ ላይ ያድርጉ <b>left</b> green area for <font color="#336600">leftCategory</font> items.<br/>',
							'የቀኝ ጣት በላዩ ላይ ያድርጉ <b>right</b> green area for <font color="#336600">rightCategory</font> items.<br/>',
							'እቃዎች አንድ በአንድ ይታያሉ.',
							'<br/>',
							'ስህተት ከሰሩ, ቀይ <font color="#ff0000"><b>X</b></font> ይታያል. ሌላኛውን ጎን ይንኩ. <u>በተቻለዎት ፍጥነት ይሂዱ</u> ትክክለኛ ሆኖ ሳለ.<br/>',
						'</p>',
